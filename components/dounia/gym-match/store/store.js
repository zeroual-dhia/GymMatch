document.addEventListener('DOMContentLoaded', function () {
    ...
    productCards.forEach(card => {
        ...
        buyButton.addEventListener('click', function () {
            ...
            alert(`Added ${quantity} of ${productName} (Size: ${selectedSize}) at a price of ${productPrice}DA each to your shopping list.`);

            cart.push({ productName, productPrice, quantity, selectedSize, productCategory });
            updateShoppingList();
