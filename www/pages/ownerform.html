...
<body>
    ...
    <form id="ownerform" action="../includes/owner.php" method="POST" enctype="multipart/form-data">     
        ...
        <div class="input-block">
            <textarea class="input" name="descreption" id="description" required="" rows ="5" placeholder="descreption"></textarea>
      ...
      <button class="container-btn-file">
       ...
       Upload your time table 
        ...
        <div class="input-block text-area">
            <textarea class="input" name="membershipPlans" id="membershipPlans" required="" rows ="5" placeholder="membershipPlans"></textarea>
        </div>
        <div class="input-block fileupload">
            <label for="file" name="gymImage" class="custum-file-upload">
                <div class="icon">
